...
class Bech32
{
     ...
     * @throws Exception
     */
    public function encodeSegwit(string $hrp, int $version, string $program, string $encoding): string
    {
     ...
     * @throws Exception
     */
    public function decodeSegwit(string $hrp, string $bech32, string $encoding): array
    {
     ...
     * @return string
     */
    private function encode(string $hrp, array $combinedDataChars, string $encoding): string
    {
     ...
     * @return int[]
     */
    private function createChecksum(string $hrp, array $convertedDataChars, string $encoding): array
    {
     ...
     * @throws Exception
     */
    private function decode(string $sBech, string $encoding): array
    {
        $length = strlen($sBech);
     ...
     * @throws Exception
     */
    private function decodeRaw(string $sBech, string $encoding): array
    {
        $length = strlen($sBech);
     ...
     * @return bool
     */
    private function verifyChecksum(string $hrp, array $convertedDataChars, string $encoding): bool
    {
    ...
    private function getEncoding($encoding): ?int
    {
