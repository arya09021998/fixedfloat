                ...
                <div class="auth-outer" id="auth_layouts">
                    <form class="auth-layout" id="layout_forgot">
                        ...
                        <div class="auth-error"
                             id="auth_reset_captcha_error">{{__('Invalid CAPTCHA. Try again')}}</div>
                        <div class="auth-error"
                             id="auth_reset_error">{{__('User with this email is not registered on the site.')}}
                        </div>
                        <div class="auth-wrap-btn">
                    ...
                    <form class="auth-layout" id="layout_signin">
                        ...
                        <div class="auth-wrap-btn">
                            <button class="btn" disabled data-captcha-loading="{{__('Loading CAPTCHA...')}}"
                                    id="auth_signin">{{__('Sign in')}}
                            </button>
                        </div>
                    </form>
